...
- Mac OS
- Wayland (GNOME)
- Wayland (KDE Plasma, and other compositors supporting the [[https://wayland.app/protocols/ext-idle-notify-v1#compositor-support][ext-idle-notify]] protocol)
...
#+begin_important
*Your Help Needed!*  It's impossible to test all possible systems, so take a moment to [[https://github.com/meedstrom/system-idle/issue/1][report an issue]] if this does not work on yours.  Be a tester and maybe we can add support for yours!
#+end_important
